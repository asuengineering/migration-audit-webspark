...
Version 0.1 is being developed in plan-only mode.

This is the design and specification surface for a future formal Drupal module, not the implementation itself.
